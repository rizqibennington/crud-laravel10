...
<head>
    ...
    <title>@yield('title') | Rizqi Huntz</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/dashboard" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Rizqi Huntz</span>
            </a>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; {{ date('Y') }} <a href="https://rizqibennington.github.io/">Rizqi
                    Huntz</a>.</strong> All
            rights
            reserved.
